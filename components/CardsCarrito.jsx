  ...
  return (
    <div className="card-carrito">
      ...
      <div className="d-flex flex-row">
        <div className="w-90-card w-50-card">
          <img src={product.image} className="card-carrito__img" />
        </div>
        <div className="d-flex flex-column justify-content-between w-90-card w-50-card ps-4">
          <div className="d-flex flex-column">
            <p className="card-carrito__parrafo">COLOR : MAGENTA</p>
            <p className="card-carrito__parrafo mb-1">TALLA : {product.size}</p>
            <div className="d-flex flex-row">
              <button
                className="card-carrito__parrafo border border-0 bg-white me-3 u-pointer"
                onClick={() => cartModificate("add")}
              >
                +
              </button>
              <p className="card-carrito__parrafo mt-3">{product.quantity}</p>
              <button
                className="card-carrito__parrafo border border-0 bg-white ms-3 u-pointer"
                onClick={() => cartModificate("remove")}
              >
                -
              </button>
            </div>
          ...
          <div className="d-flex flex-column">
            <p className="card-carrito__parrafo">
              {new Intl.NumberFormat().format(product.price)} COP
            </p>
            <button
              className="card-carrito__parrafo bg-white"
              style={{ width: "118px" }}
